...
class MainWindow(QMainWindow):
    ...
    def showContextMenu(self, position):
        menu = QMenu()
        remove_action = menu.addAction("Read selected text")
    ...
    def setupLayout(self):
        ...
        self.cef_widget.setContextMenuPolicy(Qt.CustomContextMenu)
        self.cef_widget.customContextMenuRequested.connect(self.showContextMenu)
